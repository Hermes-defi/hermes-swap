...
contract SimpleRewarderPerBlock is IRewarder, BoringOwnable {
    ...
    IMasterChefHermesV2 public immutable MC_V2;
    ...
    constructor(
        ...
        require(Address.isContract(address(_MCV2)), "constructor: MasterChefHermesV2 must be a valid contract");
    ...
    function onHermesReward(address _user, uint256 _lpAmount) external override onlyMCV2 {
        updatePool();
