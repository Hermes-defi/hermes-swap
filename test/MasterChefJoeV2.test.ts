...
describe("MasterChefHermesV2", function () {
  ...
  //     await this.hermes.transferOwnership(this.chef.address) // t-53, b=20
  ...
  //     await expect(this.rewarder.onHermesReward(this.bob.address, "100")).to.be.revertedWith("onlyMCV2: only MasterChef V2 can call this function") // t-10, b=25
  ...
  //     await this.hermes.transferOwnership(this.chef.address) // t-52, b=21
  ...
  //     // Bob should have:
  //     //   - 500 + 20*50 = 1500 (+50) HermesToken
  //     //   - 79 + 3*40*1/4 + 4*40*1/2 = 189 PartnerToken
  //     expect(await this.hermes.balanceOf(this.bob.address)).to.be.within(1500, 1550)
  ...
  //     expect(await this.hermes.balanceOf(this.treasury.address)).to.be.within(1000 - this.tokenOffset, 1020 + this.tokenOffset)
  //     expect(await this.hermes.balanceOf(this.investor.address)).to.be.within(500 - this.tokenOffset, 510 + this.tokenOffset)
  //     // MasterChefHermes and PartnerChef should have nothing
  //     expect(await this.hermes.balanceOf(this.chef.address)).to.be.within(0, 0 + this.tokenOffset)
  ...
  //     await this.hermes.transferOwnership(this.chef.address) // t-53
  ...
  //     await expect(this.rewarder.onHermesReward(this.bob.address, "100")).to.be.revertedWith("onlyMCV2: only MasterChef V2 can call this function") // t-10
  //     await this.chef.connect(this.bob).deposit(0, "0") // t-9
  //     // Bob should have:
  //     //   - 0 HermesToken
  ...
  //     await this.hermes.transferOwnership(this.chef.address) // t-52
