...
contract HermesToken is ERC20("HermesToken", "HERMES"), Ownable {
    ...
    function delegateBySig(
        ...
        require(signatory != address(0), "HERMES::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "HERMES::delegateBySig: invalid nonce");
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "HERMES::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(block.number, "HERMES::_writeCheckpoint: block number exceeds 32 bits");
