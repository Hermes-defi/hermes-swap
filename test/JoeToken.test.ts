...
describe("HermesToken", function () {
  ...
  it("should not exceed max supply of 500m", async function () {
    await expect(this.hermes.mint(this.alice.address, "500000000000000000000000001")).to.be.revertedWith("HERMES::mint: cannot exceed max supply")
    await this.hermes.mint(this.alice.address, "500000000000000000000000000")
  })
