...
module.exports = async function ({
  ...
  const hermesRouterAddress = (await deployments.get("HermesRouter02")).address;

  await deploy("HermesRoll", {
    from: deployer,
    args: [pangolinRouterAddress, hermesRouterAddress],
    log: true,
    deterministicDeployment: false,
  });
};

module.exports.tags = ["HermesRoll"];
module.exports.dependencies = ["HermesRouter02"];
